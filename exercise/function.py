...
Challenge: Write a function that takes a list of integers numbers and a single integer target. The function should return the number from numbers that is closest to the target. 
...
# The function should return 8, as 8 is the closest number to 9.
